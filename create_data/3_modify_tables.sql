...
\copy company_dim FROM 'C:\Users\truph\Desktop\Purdue\Summer_25\SQL_class\SQL_Project_Data_Job_Analysis\company_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_dim FROM 'C:\Users\truph\Desktop\Purdue\Summer_25\SQL_class\SQL_Project_Data_Job_Analysis\skills_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy job_postings_fact FROM 'C:\Users\truph\Desktop\Purdue\Summer_25\SQL_class\SQL_Project_Data_Job_Analysis\job_postings_fact.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_job_dim FROM C:\Users\truph\Desktop\Purdue\Summer_25\SQL_class\SQL_Project_Data_Job_Analysis\skills_job_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
